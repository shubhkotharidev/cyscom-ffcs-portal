  ...
  return (
    <style>{`
      ...
      .cg-root {
        ...
        --text-dim: #6F7275;
        --accent: #DFAE3D;
        --accent-soft: rgba(223, 174, 61, 0.15);
        --accent-2: #DFAE3D;
        --accent-super: #DFAE3D;
        --accent-super-soft: rgba(223, 174, 61, 0.15);
        --danger: #D33F49;
        --danger-soft: rgba(211, 63, 73, 0.14);
        --warn: #DFAE3D;
        --warn-soft: rgba(223, 174, 61, 0.14);
        --success: #70935C;
      ...
      *, *::before, *::after { box-sizing: border-box; }
      ...
      .cg-blink { opacity: 1; } /* Disabled blink for calmer UI */
      ...
      /* Corner Brackets (Removed visual styling to keep it clean, but keep classes to not break layout logic if used) */
      ...
      .cg-podium-card.rank-1 { padding: 32px 16px; border-top: 3px solid var(--accent); }
      ...
      .cg-podium-rank { font-size: 11px; font-weight: 600; color: var(--text-dim); margin-bottom: 8px; text-transform: uppercase; }
      .cg-podium-card.rank-1 .cg-podium-rank { color: var(--text); }
      .cg-podium-name { font-size: 15px; font-weight: 500; margin-bottom: 12px; word-break: break-word; }
      .cg-podium-card.rank-1 .cg-podium-name { font-size: 16px; font-weight: 600; }
      .cg-podium-points { font-family: 'JetBrains Mono', monospace; font-size: 20px; font-weight: 600; color: var(--text); }
      .cg-podium-card.rank-1 .cg-podium-points { font-size: 24px; }
      .cg-podium-you {
      ...
      .cg-lb-header { background: var(--bg-panel); font-size: 12px; font-weight: 600; color: var(--text-dim); }
      .cg-lb-row { background: var(--bg-panel); font-size: 14px; }
      .cg-lb-row.you { background: var(--bg-panel-hi); font-weight: 500; }
      .cg-lb-you-tag {
        margin-left: 8px; font-size: 9px; font-weight: 600;
        color: var(--bg); background: var(--text); padding: 2px 6px; border-radius: 2px;
      }
      ...
      .cg-dept-stack-item:hover:not(.disabled) { border-color: var(--text-dim); }
      .cg-dept-stack-item.selected { border-color: var(--text); background: var(--bg-panel-hi); border-left: 3px solid var(--accent); }
      ...
      .cg-terminal-input:focus { border-color: var(--text); }
      ...
      .cg-admin-tab.active { color: var(--text); border-bottom-color: var(--text); font-weight: 600; }
      .cg-admin-tab.active.super { color: var(--text); border-bottom-color: var(--text); font-weight: 600; }
      ...
      @media (max-width: 640px) {
        ...
        .cg-admin-tab.active, .cg-admin-tab.active.super {
          border-color: var(--text); background: var(--bg-panel-hi); color: var(--text);
        }
      }
      ...
      .cg-badge-admin { color: var(--text); border: 1px solid var(--border-hi); background: var(--bg-panel-hi); }
      .cg-badge-super { color: var(--bg); border: 1px solid var(--text); background: var(--text); }
      .cg-badge-pending { color: var(--warn); border: 1px solid var(--warn); }
      .cg-badge-approved { color: var(--success); border: 1px solid var(--success); }
      .cg-badge-rejected { color: var(--danger); border: 1px solid var(--danger); }
      ...
      .cg-stat-card-value {
        font-family: 'JetBrains Mono', monospace; font-size: 32px; font-weight: 500; color: var(--text); margin: 8px 0 4px;
      }
      .cg-stat-card-sub { font-size: 12px; color: var(--text-dim); }

      /* Empty state */
      .cg-empty { text-align: center; padding: 64px 24px; color: var(--text-dim); font-size: 14px; }
